...
| **Netflix & Chill**     | Full Stack | React, Spring Boot, PostgreSQL (Supabase), Docker, Redux & Context API, Axios, Render, Netlify      | Movie streaming, auth, admin/user roles, community board, Dockerized backend                          | [🎬 Link](https://net-flix-clone-dahee-kim.netlify.app/)        |
